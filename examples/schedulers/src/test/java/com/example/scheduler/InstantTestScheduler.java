 ...
 * a virtual time.
 *
 * CHANGED: This scheduler differ from {@link io.reactivex.schedulers.TestScheduler} that
 * instant actions are triggered automatically
 */
public final class InstantTestScheduler extends Scheduler {
     ...
     *
     * CHANGED: Changed to private because it's executed automatically
     */
    ...
    private final class TestWorker extends Worker {
        ...
        public Disposable schedule(@NonNull Runnable run, long delayTime, @NonNull TimeUnit unit) {
            ...
            // CHANGED: executing trigger actions so instant actions will execute automatically
            triggerActions();
        ...
        @Override
        public long now(@NonNull TimeUnit unit) {
            return InstantTestScheduler.this.now(unit);
        }
